...
urlpatterns = [
    ...
    path('get-progress-post-processing/<uuid:pk>', views.GetProgressPostProcessingControllerView.as_view(),
         name=views.GetProgressPostProcessingControllerView.name),
]
